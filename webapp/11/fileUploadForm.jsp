...
<form actiom = "${pageContext.request.contextPath }/fileUploadSpec3.do" method = "post" enctype = "multipart/form-data"> 
...
<div>
	...
	<c:if test="${not empty  uploadFile}">
		<img src="${pageContext.request.contextPath }${uploadFile }" />
		<c:remove var="uploadFile" scope="session"/>
	</c:if>
</div>
